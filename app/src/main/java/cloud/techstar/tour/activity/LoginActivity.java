...
import cloud.techstar.tour.json.JSONParser;
import cloud.techstar.tour.utilities.PrefManager;
...
//    }
    public boolean validate() {
        ...
        if (username.trim().length() > 0 && password.trim().length() > 0){
            ...
            Toast.makeText(LoginActivity.this,"Хэрэглэгчийн нэр нууц үг буруу байна", Toast.LENGTH_SHORT).show();
            valid = false;
        }
