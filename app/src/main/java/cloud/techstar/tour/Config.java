...
public class Config {
    public static String WebURL = "https://www.techstar.cloud";
    public static String UserService= "https://www.techstar.cloud/api/UserService.php";
